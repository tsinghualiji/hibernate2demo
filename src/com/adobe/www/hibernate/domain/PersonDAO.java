package com.adobe.www.hibernate.domain;
...
import com.adobe.www.hibernate.utils.BaseDao;
 ...
 * 
 * @see com.adobe.www.hibernate.domain.Person
...
public class PersonDAO extends BaseDao {
	...
	public static final String PSEX = "psex";
	...
	public Person findById(java.lang.Long id) {
		...
		try {
			Person instance = (Person) getSession().get(
					"cn.itcast.hibernate0909.domain.Person", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Person instance) {
		...
		try {
			List results = getSession()
					.createCriteria("cn.itcast.hibernate0909.domain.Person")
	...
	public List findByPsex(Object psex) {
		return findByProperty(PSEX, psex);
	}
